...
$sessionKey = 'd9c85151c35a319bc96f6d00945ec99a';
$template_id = '5hDyt42_w1MUMuAgemfRgMPs7p9pOaAiG4dNDtfgFb8';
// 获取客户端输入内容
$code=$_GET['code'];
$FORMID=$_GET['FORMID'];
...
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);// 无需 https 校验
$a = curl_exec($ch);
$strjson=json_decode($a);
$token = $strjson->access_token;

// 构造模板内容
$k1 = array("value"=>"机电大酒店","color"=>"#224466");
...
$key=array("keyword1"=>$k1,
          "keyword2"=>$k2,
          "keyword3"=>$k3,
          "keyword4"=>$k4,
          "keyword5"=>$k5);
$a=array("touser"=>$openid,
        "template_id"=>$template_id,
        "form_id"=>$FORMID,"data"=>$key,
